...
export function HeroHome() {
  ...
  return (
    ...
    >
      ...
      />
      <Container>
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)] lg:items-center lg:gap-12">
          <div className="space-y-5 sm:space-y-6">
            ...
            <h1
              id="hero-title"
              className="max-w-3xl text-balance text-[1.7rem] font-bold leading-snug tracking-tight text-navy sm:text-4xl sm:leading-tight lg:text-[3rem] lg:leading-[1.12]"
            >
            ...
            <p className="text-[0.8125rem] text-muted sm:text-sm">
              ...
              <span lang="vi" className="lang-vi mt-0.5 block text-[0.75rem] text-navy-soft sm:mt-0 sm:inline sm:text-[0.8125rem]">
                {cta.profileRead.vi}
              </span>
          ...
          <aside
            className="relative mx-auto w-full max-w-[420px] overflow-hidden rounded-[2rem] border border-navy/10 bg-[linear-gradient(160deg,#ffffff_0%,#f7fbfb_48%,#e6f4f2_100%)] p-5 shadow-[0_28px_80px_rgba(11,31,58,0.16)] backdrop-blur sm:p-6 lg:max-w-none"
          ...
          >
            ...
            <div className="mx-auto flex max-w-[260px] flex-col items-center text-center sm:max-w-[280px]">
              <div className="flex h-44 w-44 items-center justify-center rounded-full bg-gradient-to-br from-white to-accent-muted/80 ring-4 ring-white sm:h-56 sm:w-56">
                <MiraiMascot variant="smile" className="h-48 w-48 sm:h-60 sm:w-60" />
              </div>
              ...
              <dl className="mt-5 grid w-full grid-cols-2 gap-2 text-left">
                {hero.trustPoints.map((point) => (
                  <div key={point.ja} className="min-w-0 rounded-xl border border-border bg-white/70 p-3">
