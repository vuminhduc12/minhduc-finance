...
export const articleCategories: readonly { id: ArticleCategory; label: Bi }[] = [
  { id: "risk", label: { ja: "詐欺予防", vi: "Phòng tránh lừa đảo" } },
  { id: "life-money", label: { ja: "生活とお金", vi: "Tiền bạc đời sống" } },
  { id: "nisa", label: { ja: "NISA・資産形成", vi: "NISA & tích sản" } },
  { id: "remittance", label: { ja: "送金・手続き", vi: "Chuyển tiền & thủ tục" } },
  { id: "debt", label: { ja: "借金・支払い", vi: "Nợ & thanh toán" } },
] as const;
